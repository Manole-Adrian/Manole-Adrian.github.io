  ...
  return (
    ...
    >
      ...
      <div className="teamText">
        Echipa noastra abia asteapta sa te vada la eveniment! Asa ca, ce mai astepti? 
      </div>
      ...
      <a target="_blank" href="https://docs.google.com/forms/d/e/1FAIpQLScBT18PYYb60uD5ylopUUCqYXiXtPeBHj_HoEc2zuaY2YSOtg/viewform?usp=sf_link" className="applyButton teamApplyButton">
        Inscrie-te chiar acum <KeyboardDoubleArrowRightIcon className="applyIcon" />
      </a>
    </section>
  );
}
